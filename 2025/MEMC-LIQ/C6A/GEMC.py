...
gomc_steps_production    = 50000000 # set value for pauper = 60 * 10**6
...
gomc_nvt_equilb_output_name_str="C6A_nvt"
...
gomc_equilb_output_name_str="C6A_equil"
...
gomc_production_output_name_str="C6A_prod"
...
def build_charmm(job, write_files=True):
    ...
    box_0_temp_to_length_ang_dict = {300: 48,
                                     325: 48,
                                     350: 49,
                                     375: 49,
                                     400: 50,
    ...
    box_1_temp_to_length_ang_dict = {300: 180,
                                     325: 125,
                                     350: 95,
                                     375: 80,
                                     400: 65,
    ...
    box_0_temp_to_molecules_dict = {300: 470,
                                    325: 470,
                                     350: 470,
                                     375: 470,
                                     400: 470,
    ...
    box_1_temp_to_molecules_dict = {300: 30,
                                    325: 30,
                                     350: 30,
                                     375: 30,
                                     400: 30,
...
def build_psf_pdb_ff_gomc_conf(job):
    ...
    box_1_temp_to_rcutcoulomb_dict = {300:50,
                                     325: 50,
                                     350: 30,
                                     375: 20,
                                     400: 20,
