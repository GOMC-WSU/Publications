...
gomc_binary_path = "~/GOMC/MEMC/bin"


# number of simulation steps
gomc_steps_nvt_equilibration = 5000000 # steps for NVT pre-equilibration step
gomc_steps_equilibration = 25000000 #  set value for paper = 60 * 10**6
gomc_steps_production    = 25000000 # set value for pauper = 60 * 10**6
...
block_ave_output_freq = 5000000 # Monte Carlo Steps between console output
...
gomc_nvt_equilb_output_name_str="DME_nvt"
...
gomc_equilb_output_name_str="DME_equil"
...
gomc_production_output_name_str="DME_prod"
...
def build_charmm(job, write_files=True):
    ...
    box_0_temp_to_length_ang_dict = {275: 38,
                                     300: 39,
                                     325: 40,
                                     350: 40,
                                     375: 41,
    ...
    box_1_temp_to_length_ang_dict = {275: 69,
                                     300: 48,
                                     325: 39,
                                     350: 34,
                                     375: 50,
    ...
    box_0_temp_to_molecules_dict = {275:470,
                                    300: 470,
                                    325: 470,
                                     350: 470,
                                     375: 470,
    ...
    box_1_temp_to_molecules_dict = {275:30,
                                    300: 30,
                                    325: 30,
                                     350: 30,
                                     375: 30,
    ...
    box_liq = mb.fill_box(compound=molecule_type_list,
                          n_compounds=box_0_molecules,seed=job.doc.replica_number_int,
    ...
    box_vap = mb.fill_box(compound=molecule_type_list,
                          n_compounds=box_1_molecules,seed=job.doc.replica_number_int,
...
def build_psf_pdb_ff_gomc_conf(job):
    ...
    box_0_temp_to_rcutcoulomb_dict = {275: 12,
                                     300:12,
                                     325: 12,
                                     350: 12,
                                     375: 12,
    ...
    box_1_temp_to_rcutcoulomb_dict = {275:20,
                                     300: 20,
                                     325: 14,
                                     350: 12,
                                     375: 12,
...
def part_5c_analysis_critical_and_boiling__points_replicate_data(*jobs):
    ...
    # ***************************************************
    lowest_Tr_for_critical_calcs = 0.65
