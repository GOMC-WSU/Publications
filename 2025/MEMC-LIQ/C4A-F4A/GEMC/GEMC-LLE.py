...
def build_charmm(job, write_files=True):
    ...
    scaled_forcefield2 = '../../trappe-mie-scaled2.xml'
...
# kludge for NBFIX
    NBFIX_out = 'CH30 CF30 81.2559807 4.055 12\n\
            CF20 CH30 45.68378268 4.24 12\n\
...
def part_5a_analysis_individual_simulation_averages(job):
    ...
    # this is set to use all values.  However, it allows the ability to set a data range if needed
    step_start = 0 * 10 ** 6
    step_finish = 1 * 10 ** 12
